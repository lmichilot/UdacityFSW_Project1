...
#Creates six movies
wonderMovie = media.Movie("Wonder Woman",
...
spiderMovie = media.Movie("Spiderman",
                          "This is a story of Peter Parker who is a nerdy high-schooler.Spider-Man: Homecoming is a 2017 American superhero film based on the Marvel Comics character Spider-Man, co-produced by Columbia Pictures and Marvel Studios.",
...
movies = [wonderMovie,loganMovie,spiderMovie,dunkirkMovie,apesMovie,thorMovie];
